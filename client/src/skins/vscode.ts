...
const TEXT: TextTable = {
  ...
  'snake.padUp': 'move up',
  'snake.padDown': 'move down',
  'snake.padLeft': 'move left',
  'snake.padRight': 'move right',
  'snake.padItem': 'Plugin',
  'snake.padDash': 'Dash',
  'snake.score': '{n} lines',
  'snake.bodyLen': 'len {n}',
  'snake.alive': 'running',
  ...
  'mahjong.selectedTile': 'Staged {tile}',
  'mahjong.confirmDiscard': 'Commit',
  ...
  'mahjong.bannerChi': 'Merged run!',
  'mahjong.bannerPeng': 'Merged x3!',
  'mahjong.bannerGang': 'Merged x4!',
  'mahjong.bannerSelfDraw': 'Shipped solo!',
  'mahjong.bannerWin': 'Shipped!',
  'mahjong.bannerShoot': 'Broke the build!',
...
const ERRORS: Skin['errors'] = {
  ...
  MONSTER_CHARMED: 'That worker is detached for a few passes — it will not take your commands',
