...
export const CASINO_TEXT = {
  ...
  'snake.optWraparound': '邊界穿透',
  'snake.optUnlimitedLives': '命無限',
  'snake.optTimeLimit': '無限命時限（秒）',
  'snake.optHeadOnCollision': '頭對頭規則',
  'snake.optHeadBounce': '彈開不死',
  'snake.optHeadClash': '兩敗俱死',
  'snake.optCutting': '截斷機制（X 鍵衝刺）',
  'snake.optLargeMap': '大地圖（4 倍）',
  'snake.optItems': '開啟道具',
  'snake.itemSpeed': '加速',
  'snake.itemReverse': '反轉',
  'snake.itemShield': '護盾',
  'snake.itemBullet': '子彈',
  'snake.itemMagnet': '磁鐵',
  'snake.useItemHint': '空白鍵使用道具欄第一格',
  'snake.dashHint': 'X 鍵衝刺截斷（先充能 0.5 秒，冷卻 15 秒）',
  'snake.dashCharging': '充能中',
  ...
  'mahjong.bannerChi': '吃！',
  'mahjong.bannerPeng': '碰！',
  'mahjong.bannerGang': '槓！',
  'mahjong.bannerSelfDraw': '自摸！',
  'mahjong.bannerWin': '胡！',
  'mahjong.bannerShoot': '放槍！',
